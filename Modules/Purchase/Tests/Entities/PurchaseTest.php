...
namespace Modules\Purchase\Tests\Entities;
...
class PurchaseTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->model = $this->app->make(Purchase::class);
    }
    ...
    {
        $this->assertEquals($this->model->getTable(), 'purchase_purchases');
    }
    ...
    {
        $fillable = ['account_id', 'description', 'amount'];
